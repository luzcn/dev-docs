{:en {:header {:brand-name "Bare Metal IaaS"
  ...
  :instances {:header "Instances"
              ...
              :badge-label "I"}
  :db-systems {:badge-label "DBI"
               :header "DB Systems"
               :list-count-title "database systems"
               :no-db-systems "There are no database systems"
               :create-db-system "Launch DB System"
               :create-pending "Launching DB System"
               ...
               :hostname-and-domain "Host and Domain URL"
               :licenseType "License Type"
               :listenerPort "Port"
               :databaseEdition "Oracle Database Software Edition"
               :dataMirroringOption "Data Mirroring Option"
               :dataStoragePercentage "Data Storage Percentage"
               :subfieldset-reuse-parameters "Reuse DB System Launch Parameters"
               :subfieldset-database-system-information "DB System Information"
               :subfieldset-network-information "Network Information"
               :subfieldset-database-home-information "Database Information"
               :help-cpuCoreCount-no-shape "Increment by %d"
               :help-cpuCoreCount "Increment by %d, maximum of %d"
               :help-select-shape "Select 'Shape'"
               :help-shape-disabled-text "Select 'Availability Domain'"
               :help-subnet-disabled-text "Select 'Availability Domain' and 'Cloud Network'"
               :help-hostname-and-domain "Enter a 'Host Name' and 'Host Domain Name'"
               ;; LaunchDbSystem is odd, because it contains nested subobjects. Rather than expose
               ;; those as top-level, for now we group them under db-systems, since we're hiding
               ;; the multiple levels of nesting.
               :db-homes-dbVersion "Database Version"
               :databases-dbName "Database Name"
               :databases-adminPassword "Database Admin Password"
               :databases-adminPassword-confirmation "Confirm Database Admin Password"}
  ...
  :route-rules {:singular "route rule"
                ...
                :confirmation "The route table was updated: "}
  ...
  :lb-backends {:header "Backends"
      ...
      :vcns {:header "Cloud Networks (VCNs)"
             ...
             :auto-create {:label "Create VCN plus related resources"
                           ...
                           :confirmation "The cloud network was created: "
      ...
      :data {:loading "Loading"
             ...
             :error "An unexpected error occured while loading the data, we will try again shortly."
             :no-data "–"}
